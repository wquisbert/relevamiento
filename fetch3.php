...
$query .= "SELECT * FROM deudas  WHERE hosp = '".$_SESSION["hospital"]."' ";
...
foreach($result as $row)
{
    ...
    $sub_array[] = $row["dispox"];
    $sub_array[] = $row["nropac"];
    $sub_array[] = $row["saluti"];
    $sub_array[] = $row["totdec"];
    $sub_array[] = $row["totdecox"];
